    ...
    const submit = async () => {
        ...
        if (passwd === passwd2) {
            ...
            await axios.post(baseURL + "register", json)
                .then(res => {
                    if (res.data === "SUCCESS")
                        showAlert("Registro satisfactorio")

                    else if (res.data === "NOT_SUCCESS")
                        showAlert("Este nombre de usuario ya existe")
                })

        } else
            showAlert("La contraseñas no son las mismas")  
    }
        ...
        <div className="d-flex flex-column col-xl-3 col-md-5 col-8 col-lg-4 shadow p-3 mb-5 bg-white rounded" style={{ marginTop: "150px" }}>
            ...
            <div className="tab-content">
                ...
                <div className="form-check d-flex  mb-4">
                    ...
                    <label className="form-check-label" > Me gustaría recibir noticias </label>
                </div>
